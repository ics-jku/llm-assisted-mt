...
class MTCGenerator(ABC):
    ...
    def generate_mtc(self):
        ...
        self.generate_file(self.path+"main2.cpp", 2, self.followup_testcase, self.support_functions)
        #self.generate_file(self.path+"main2.cpp", 2, self.followup_testcase)

    def generate_file(self, src_path, screenshot_num, testcase_fn, support_functions = None):
        ...
        if support_functions is not None:
